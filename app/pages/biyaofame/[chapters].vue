  ...
  <div>
    ...
    <div class="chapter-nav-btns flex justify-center gap-6 mt-12 mb-8">
      <button v-if="currentNum > 1"
        class="catBtn chapter-btn prev rounded-xl bg-gradient-to-r from-green-500 via-green-400 to-green-200 font-semibold px-6 py-2 shadow-lg hover:from-green-600 hover:to-green-300 hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 active:scale-95"
        @click="goToChapter(currentNum - 1)">上一章</button>
      <button
        class="catBtn chapter-btn catalog rounded-xl bg-gradient-to-r from-green-400 to-green-600 text-green-900 font-bold px-6 py-2 shadow-md hover:from-green-500 hover:to-green-700  hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 active:scale-95"
        @click="goToCatalog">目录</button>
      <button v-if="currentNum < maxChapterNum"
        class="catBtn chapter-btn next rounded-xl bg-gradient-to-r from-green-200 via-green-400 to-green-500 text-white font-semibold px-6 py-2 shadow-lg hover:from-green-300 hover:to-green-600 hover:scale-105 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-green-300 active:scale-95"
